      ...
      <div className="form">
        ...
        <div className="section references">
              ...
              <div className="row container-fluid" key={index}>
                <div className="item">
                  ...
                  <textarea
                    ...
                    value={item.desig}
                    onChange={(e) =>
                      handleChange(e, index, references, "desig")
                    }
                  />
                  <input
                    type="text"
                    ...
                    value={item.phone}
                    onChange={(e) =>
                      handleChange(e, index, references, "phone")
                    }
                  />
                  <input
                    type="email"
                    ...
                    value={item.email}
                    onChange={(e) =>
                      handleChange(e, index, references, "email")
                    }
                  />
                </div>
                <button
          ...
          <button
            className="btn btn-sm btn-dark"
            onClick={() =>
              addRow(references, { name: "", desig: "", phone: "", email: "" })
            }
          >
            Add
          </button>
              ...
              <div className="container-fluid" key={index}>
                <div className="row item">
                  <input
                    ...
                    value={item.title}
                    onChange={(e) =>
                      handleChange(e, index, activities, "title")
                    }
                  />
                </div>
                <div className="row">
