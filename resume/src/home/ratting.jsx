...
function SampleNextArrow(props) {
    ...
    return (
      ...
      <CiCircleChevRight style={{width:"40px",height:"40px",color:"black"}} className={className} onClick={onClick}/>
  ...
  function SamplePrevArrow(props) {
    ...
    //     onClick={onClick}
    //   />
      <CiCircleChevLeft style={{width:"40px",height:"40px",color:"black"}} className={className} onClick={onClick} />
    );
  }
    ...
    var settings = {
      ...
      return (
        <div className="slider-container w-[80%] m-auto" >
            <h1 className="heading">Reviewed by the community. Trusted by professionals</h1>
          <Slider {...settings} >
          
          {
                    ...
                    <div className="rating">
                        ...
                        {
                            ele.whitestar && <img src="https://resume.io/assets/media/star-graydc909e7ff92914870d42.svg" alt="" /> 
                        }
